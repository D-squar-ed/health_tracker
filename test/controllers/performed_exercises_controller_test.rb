...
class PerformedExercisesControllerTest < ActionController::TestCase
  ...
  test "should create performed_exercise" do
    assert_difference('PerformedExercise.count') do
      post :create, performed_exercise: { date: @performed_exercise.date, exercise_type_id: @performed_exercise.exercise_type_id, workout: @performed_exercise.workout }
    end
  ...
  test "should update performed_exercise" do
    patch :update, id: @performed_exercise, performed_exercise: { date: @performed_exercise.date, exercise_type_id: @performed_exercise.exercise_type_id, workout: @performed_exercise.workout }
    assert_redirected_to performed_exercise_path(assigns(:performed_exercise))
  end
